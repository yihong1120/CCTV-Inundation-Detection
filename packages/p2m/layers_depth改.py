...
from inits import glorot, zeros, uniform, ones
...
class GraphConvolution(Layer):
    ...
    def __init__(self, input_dim, output_dim, placeholders, dropout=False,
        ...
        self.act = act
        if gcn_block_id == 1:
            self.support = placeholders.support1_depth
        elif gcn_block_id == 2:
            self.support = placeholders.support2_depth
        elif gcn_block_id == 3:
            self.support = placeholders.support3_depth
...
class GraphPooling(Layer):
	...
	def __init__(self, placeholders, pool_id=1, **kwargs):
		...
		self.pool_idx = placeholders.pool_idx_depth[pool_id-1]
